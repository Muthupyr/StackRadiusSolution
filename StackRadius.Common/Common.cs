...
namespace StackRadius.Common
{
    public static class Common
    {
        ...
        public static Dictionary<string, string> GetSTPMasterFieldList()
        {
            ...
            string[] fieldName = ("amc_code,amc_name,nse_scheme_code,scheme_name,scheme_isin,scheme_type,astp_transaction_mode," +
                      "astp_in_minimum_installment_amount,astp_in_maximum_installment_amount,astp_in_multiplier_amount," +
            ...
            string[] fieldType = ("string,string,string,string,string,string,string," +
                                  "int,long,double,int,long,double,double,int,double,int,int,int,int,string,string,int,int,int,string").Split(',');
        ...
        public static Dictionary<string, string> GetSWPMasterFieldList()
        {
            ...
            string[] fieldName = ("amc_code,amc_name,nse_scheme_code,scheme_name,scheme_isin,scheme_type,aswp_transaction_mode," +
                                  ...
                                  "aswp_frequency,aswp_dates,aswp_minimum_gap,aswp_maximum_gap,aswp_installment_gap,aswp_status")
                                  .Split(',');
