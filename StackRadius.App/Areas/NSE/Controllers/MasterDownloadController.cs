...
namespace StackRadius.App.Areas.NSE.Controllers
{
    ...
    public class MasterDownloadController : Controller
    {
        ...
        private string SaveToSchemaMaster(List<string> TextLines, Dictionary<string, string> fieldNames)
        {
            ...
            try
            {
                for (int i = 0; i < TextLines.Count; i++)
                {
                    ...
                    // This is just to limit the number of records to 100 for testing purpose.
                    if (i == 101) 
                    {
                        break;
                    }
        ...
        {
            string data = "";
            NSESIPMasterModel sipMasterObj = new NSESIPMasterModel();
        ...
        {
            string data = "";
            NSESTPMasterModel stpMasterObj = new NSESTPMasterModel();
        ...
        {
            string data = "";
            NSESWPMasterModel swpMasterObj = new NSESWPMasterModel();
            NSESWPMasterRepository repo = new NSESWPMasterRepository();
